...
const mutationDocExt = {
    Mutation: {
        ...
        acDocUrl(_, {id, docUrl, noProceso}, {pubsub, db}) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield db.collection(constants_1.COLECCIONES.DOC_EXTERNA).findOneAndUpdate({_id: new bson_1.ObjectId(id)}, {$set: {docUrl, noProceso}}).then((documento) => __awaiter(this, void 0, void 0, function* () {
                    yield notTodosDocsExt(pubsub, db);
                    return {
                        estatus: true,
